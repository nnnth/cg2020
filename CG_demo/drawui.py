...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.menu_help = QtWidgets.QAction(self.menubar)
        self.menu_2.setObjectName("menu_help")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.menu_help.setText(_translate("MainWindow", "帮助"))
        ...
        self.action_line2.setText(_translate("MainWindow", "直线"))
        self.action_line2.setShortcut(_translate("MainWindow", "Ctrl+L"))
        self.action_polygon2.setText(_translate("MainWindow", "多边形"))
        self.action_polygon2.setShortcut(_translate("MainWindow", "Ctrl+P"))
        self.action_ellipse2.setText(_translate("MainWindow", "椭圆"))
        self.action_ellipse2.setShortcut(_translate("MainWindow", "Ctrl+E"))
        self.action_curve2.setText(_translate("MainWindow", "曲线"))
        self.action_curve2.setShortcut(_translate("MainWindow", "Ctrl+C"))
        self.action_move2.setText(_translate("MainWindow", "平移"))
        self.action_move2.setShortcut(_translate("MainWindow", "Ctrl+M"))
        self.action_rotate2.setText(_translate("MainWindow", "旋转"))
        self.action_rotate2.setShortcut(_translate("MainWindow", "Ctrl+R"))
        self.action_scale2.setText(_translate("MainWindow", "缩放"))
        self.action_scale2.setShortcut(_translate("MainWindow", "Ctrl+A"))
        self.action_clip2.setText(_translate("MainWindow", "裁剪"))
        self.action_clip2.setShortcut(_translate("MainWindow", "Ctrl+B"))
        self.action_pen.setText(_translate("MainWindow", "画笔"))
        self.action_fill.setText(_translate("MainWindow", "填充"))
        self.action_click.setText(_translate("MainWindow", "选择图元"))
        self.action_down.setText(_translate("MainWindow", "置于底层"))
